...
namespace Epiphyllum.TemanRS.Repositories.DbManager
{
    /// <summary>
    /// Represents database context
    /// </summary>
    public partial class EpiphyllumDbContext : DbContext, IDbContext
    {
        public EpiphyllumDbContext(DbContextOptions<EpiphyllumDbContext> options) : base(options)
        {
        }
